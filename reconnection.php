...
<h5 style="font-size:20px; color:blue;">Water Reconnection | Only For Assigned Customer Service | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Water Reconnection For Assigned Customer Service</td>
</tr>
</table>
...
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Meter Number (#) </span><span style="color:red">*</span>
<input class="form-control text-box single-line" name="mnumber" type="text" style="height:35px;font-size:16px;"required/>
</div></div>
...
<div class="row" style="padding-top: 5px">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Do you have water Service? </span><span style="color:red">*</span>
<select for="select" name="service" class="form-control text-box single-line" style="height:35px;font-size:16px;"required>
...
<select for="select" name="resident" class="form-control text-box single-line" style="height:35px;font-size:16px;"required>
<option disabled selected>Select</option>
...
<input class="form-control text-box single-line"type="text" name="street" style="height:35px;font-size:16px;"required/>
</div>

<div class="col-md-4">
<span style="font-size:16px;color:blue;">House Number </span><span style="color:red">*</span>
<input class="form-control text-box single-line"type="text" name="hnumber" style="height:35px;font-size:16px;"required/>
</div>
</div>

<div class="row" style="padding-top: 5px">
<div class="col-md-4">
<span style="font-size:16px;color:blue;">Owner Name </span><span style="color:red">*</span>
<input class="form-control text-box single-line"type="text" name="fname" style="height:35px;font-size:16px;"required/>
</div>


<div class="col-md-4">
<span style="font-size:16px;color:blue;">Reason for Reconnection </span><span style="color:red">*</span>
<textarea class="form-control text-box single-line" name="reason" style="height:55px;font-size:16px;"required></textarea>
</div>

<div class="col-md-4">
<span style="font-size:16px;color:blue;">Application Date </span><span style="color:red">*</span>
<input class="form-control text-box single-line"type="date" name="adate" style="height:35px;font-size:16px;"required/>
</div>
</div>


<?php
$bank = array("Mpesa","Airtel Money","Tigopesa","Halopesa","CRDB","NBC","NMB","TPB","Mkombozi");
...
<input class="form-control text-box single-line"type="date" name="pdate" style="height:35px;font-size:16px;"required/>
</div>
</div>

<br><br>
<div class="col-md-12">
<span style="font-size:16px;color:blue;">I agree terms and conditions </span><span style="color:red">*</span>
<input type="checkbox" name="term" value="Yes" style="height:35px;font-size:16px;"required/>
</div>
...
<?php
							...
							else
							{
									...
									//$check="SELECT * FROM reconnection WHERE FName = '$_POST[fname]'";
									...
									{
										$new ="Not Conform";
$query="INSERT INTO  reconnection (RNumber, MNumber, Service, Resident, Street, HNumber, FName, Reason, ADate, Mode, Phone, PDate, Term, stat) VALUES ('$_POST[ref_number]','$_POST[mnumber]','$_POST[service]','$_POST[resident]','$_POST[street]','$_POST[hnumber]','$_POST[fname]','$_POST[reason]','$_POST[adate]','$_POST[mode]','$_POST[phone]','$_POST[pdate]','$_POST[term]','$new')";
										...
										{
											echo "<script type='text/javascript'> alert('Your application has not been sent')</script>";

											echo "<script type='text/javascript'> window.location='reconnection.php'</script>";
