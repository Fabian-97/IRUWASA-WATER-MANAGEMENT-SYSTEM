...
<h5 style="font-size:20px; color:blue;">Service Reference number | Use the reference# for application | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Created Reference#</td>
</tr>
</table>

<!--#######################reference###############################################--->

<h4>Thank you for create reference number at IRUWASA, your Reference# is  <?php echo $_SESSION['aptno'];?>  </h4>
