...
<legend>1<sup>st</sup> PROCEDURE</legend>
...
<a href="" class="link"style="color:blue;font-size:16px;">Login</a></div>
...
<p align="center">
<a href="" class="link"style="color:blue;font-size:16px;">Signup</a></div>
                
<div align="center" style="background-color:#E4E7EC" onmouseover="this.style.background='#C8D9ED'"
onMouseOut="this.style.background='#E4E7EC'">
<p align="center">
<a href="" class="link"style="color:blue;font-size:16px;">Reset Password</a></div>
</fieldset>
</div>

<div class="col-md-3 " style="height: 250px;padding-bottom: 5px;">
<fieldset class="fieldset" style="">
<legend>2<sup>nd</sup> PROCEDURE</legend>
<div align="center" style="background-color:#E4E7EC; margin-bottom:5px" onmouseover="this.style.background='#C8D9ED'" onMouseOut="this.style.background='#E4E7EC'" >
...
onMouseOut="this.style.background='#E4E7EC'">
<p align="center">
<a href="" class="link"style="color:blue;font-size:16px;">Sewer Application</a></div>

<div align="center" style="background-color:#E4E7EC" onmouseover="this.style.background='#C8D9ED'"
onMouseOut="this.style.background='#E4E7EC'">
<p align="center">
<a href="" class="link"style="color:blue;font-size:16px;">Attach Passport Size</a></div>
</fieldset>
</div>

<div class="col-md-3 " style="height: 250px;padding-bottom: 5px;">
<fieldset class="fieldset" style="">
<legend>3<sup>rd</sup> PROCEDURE</legend>

<div align="center" style="background-color:#E4E7EC; margin-bottom:5px" onmouseover="this.style.background='#C8D9ED'" onMouseOut="this.style.background='#E4E7EC'" >
<a href="" class="link"style="color:blue;font-size:16px;">GEPG Payment</a></div>
...
onMouseOut="this.style.background='#E4E7EC'">
<p align="center">
<a href="" class="link"style="color:blue;font-size:16px;">Customer Approval</a></div>
</fieldset>
</div>
...
<div class="col-md-3 " style="height: 250px;padding-bottom: 5px;">
<fieldset class="fieldset" style="">
<legend>4<sup>th</sup> PROCEDURE</legend>

<div align="center" style="background-color:#E4E7EC; margin-bottom:5px" onmouseover="this.style.background='#C8D9ED'" onMouseOut="this.style.background='#E4E7EC'" >
<a href="" class="link"style="color:blue;font-size:16px;">Water Forum</a></div>

<div align="center" style="background-color:#E4E7EC" onmouseover="this.style.background='#C8D9ED'"
onMouseOut="this.style.background='#E4E7EC'">
<p align="center">
<a href="" class="link"style="color:blue;font-size:16px;">Rate Us</a></div>
                
<div align="center" style="background-color:#E4E7EC" onmouseover="this.style.background='#C8D9ED'"
onMouseOut="this.style.background='#E4E7EC'">
<p align="center">
<a href="" class="link"style="color:blue;font-size:16px;">Contact Us</a></div>
</fieldset>
