...
<h5 style="font-size:20px; color:blue;">Service Available | Application Service Cost | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Iruwasa Service and its cost in (TSHS)</td>
</tr>
</table>
...
<tr> <td><?php echo $cnt;?></td> <td style="font-size: 14px;"><?php  echo $row['ServiceName'];?></td><td style="font-size: 14px;"><?php  echo $row['Cost'];?></td> </tr><?php 
$cnt=$cnt+1;
}?>
