...
<h5 style="font-size:20px; color:blue;">Meter Number | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Search Meter Number</td>
</tr>
</table>
...
<div class="form-group"> <label for="exampleInputEmail1" style="font-size: 18px;font-weight: normal;">Search by landlord name or house number</label> <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" style="font-size: 16px;height: 10%;">
...
<?php
$ret=mysqli_query($con,"select *from  tbmeter where Landlord like '%$sdata%' || HNumber like '%$sdata%'");
...
<td style="font-size: 14px;"><?php  echo $row['INumber'];?></td>
<td style="font-size: 14px;"><?php  echo $row['Resident'];?></td> 
<td style="font-size: 14px;"><?php  echo $row['Street'];?></td>
<td style="font-size: 14px;"><?php  echo $row['Reference'];?></td> 
<td style="font-size: 14px;"><?php  echo $row['Landlord'];?></td>
<td style="font-size: 14px;"><?php  echo $row['Address'];?></td> 
<td style="font-size: 14px;"><?php  echo $row['HNumber'];?></td>
<td style="font-size: 14px;"><?php  echo $row['Employee'];?></td> 
<td style="font-size: 14px;"><?php  echo $row['Mobile'];?></td> 
<td style="font-size: 14px;"><?php  echo $row['NPipe'];?></td>
<td style="font-size: 14px;"><?php  echo $row['Date'];?></td>
<td style="font-size: 14px;"><a href="meter_print.php?printid=<?php echo $row['id'];?>" style="font-size: 14px;"><img src="img/6.jpg" height="40%"></a></td> 
...
$cnt=$cnt+1;
  ...
  <tr>
    <td colspan="13" style="font-size: 14px;"> No record found against this search</td>
