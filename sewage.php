...
<h5 style="font-size:20px; color:blue;">Water Sewage Service | Only For Assigned Customer Service | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Water Sewage Service</td>
</tr>
</table>
...
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Resident Area </span><span style="color:red">*</span>
...
<div class="row" style="padding-top: 5px">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">House Owner </span><span style="color:red">*</span>
<input class="form-control text-box single-line"type="text" name="owner" style="height:35px;font-size:16px;"required/>
</div></div>

<div class="row" style="padding-top: 5px">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Number of Trip </span><span style="color:red">*</span>
<input class="form-control text-box single-line"type="text" name="ntrip" style="height:35px;font-size:16px;"required/>
</div></div>
...
<div class="row" style="padding-top: 5px">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Cost per Trip </span><span style="color:red">*</span>
<select name="tcost"  class="form-control text-box single-line" style="height:35px;font-size:16px;">
<option disabled selected>select</option>
<?php
...
<?php
$road = array("Good","Satisfication","Extreme Bad");

?>
<div class="row" style="padding-top: 5px">
<div class="col-md-6">
<span style="font-size:16px;color:blue;">Road Condition </span><span style="color:red">*</span>
<select name="rcondition"  class="form-control text-box single-line" style="height:35px;font-size:16px;">
<option disabled selected>select</option>
<?php
...
<?php
							...
							else
							{
									...
									//$check="SELECT * FROM sewage WHERE service = '$_POST[service]'";
									$rs = mysqli_query($con,$check);
									$data = mysqli_fetch_array($rs, MYSQLI_NUM);
									if($data[0] > 1) {
										echo "<script type='text/javascript'> alert('Service Already in Exists')</script>";
									...
									{
										$new ="Not Conform";
$query="INSERT INTO  sewage (RNumber, Resident, Street, HNumber, Owner, NTrip, TCost, RCondition, ADate, Mode, Phone, PDate, Term, stat) VALUES ('$_POST[ref_number]','$_POST[resident]','$_POST[street]','$_POST[hnumber]','$_POST[owner]','$_POST[ntrip]','$_POST[tcost]','$_POST[rcondition]','$_POST[adate]','$_POST[mode]','$_POST[phone]','$_POST[pdate]','$_POST[term]','$new')";
										...
										else
										{
											...
											echo "<script type='text/javascript'> window.location='sewage.php'</script>";
