...
$details=$_POST['details'];
    ...
    $query=mysqli_query($con, "insert into  tblcustomers(Name,Service,Date,Resident,Details) value('$name','$service','$date','$resident','$details')");
    if ($query) {
echo "<script>alert('Customer request has been sent.');</script>"; 
echo "<script>window.location.href = 'request_invoice.php'</script>"; 
 } else {
...
<h5 style="font-size:20px; color:blue;">Request invoice | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Request invoice</td>
</tr>
</table>
<form method="post">
...
<div class="row">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Nick Name </span><span style="color:red">*</span>
<input class="form-control text-box single-line" id="name" name="name" value="" type="text" style="height:35px;font-size:16px;"required />
</div>
</div>

<div class="row" style="padding-top:5px">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Service Category </span><span style="color:red">*</span>
...
<div class="row" style="padding-top: 5px">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Date </span><span style="color:red">*</span>
<input class="form-control text-box single-line" name="date" type="date" style="height:35px;font-size:16px;"required />
</div></div>
...
<select name="resident"  class="form-control text-box single-line" style="height:35px;font-size:16px;">
<option disabled selected>select</option>
...
<div class="row" style="padding-top: 5px">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Description </span><span style="color:red">*</span>
<textarea class="form-control text-box single-line" id="details" name="details"style="height:55px;font-size:16px;"required placeholder="Leave a short description"></textarea>
</div></div>
