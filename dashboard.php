                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h4 class="card-title"><img src="img/5.gif"></h4>
                                        <?php
...
<div class="row">
<div class="col-md-3 " style="height: 250px; padding-bottom: 5px;">
<fieldset class="fieldset" style="">
<legend>1<sup>st</sup> REFERENCE NUMBER</legend>
...
<a href="pdf files/reference.pdf" class="link"style="color:blue;font-size:16px;">Create Reference</a></div>
...
<p align="center">
<a href="pdf files/search_reference.pdf" class="link"style="color:blue;font-size:16px;">Search Reference</a></div>
                
<div align="center" style="background-color:#E4E7EC" onmouseover="this.style.background='#C8D9ED'"
onMouseOut="this.style.background='#E4E7EC'">
<p align="center">
<a href="pdf files/reference_3.pdf" class="link"style="color:blue;font-size:16px;">How to Use</a></div>
</fieldset>
</div>

<div class="col-md-3 " style="height: 250px;padding-bottom: 5px;">
<fieldset class="fieldset" style="">
<legend>2<sup>nd</sup> INVOICE NUMBER</legend>
<div align="center" style="background-color:#E4E7EC; margin-bottom:5px" onmouseover="this.style.background='#C8D9ED'" onMouseOut="this.style.background='#E4E7EC'" >
<a href="pdf files/invoice.pdf" class="link"style="color:blue;font-size:16px;">Request Invoice</a></div>

<div align="center" style="background-color:#E4E7EC" onmouseover="this.style.background='#C8D9ED'"
onMouseOut="this.style.background='#E4E7EC'">
<p align="center">
<a href="pdf files/search_invoice.pdf" class="link"style="color:blue;font-size:16px;">Search Invoice</a></div>
                
<div align="center" style="background-color:#E4E7EC" onmouseover="this.style.background='#C8D9ED'"
onMouseOut="this.style.background='#E4E7EC'">
<p align="center">
<a href="pdf files/view_invoice.pdf" class="link"style="color:blue;font-size:16px;">View Invoice</a></div>

<div align="center" style="background-color:#E4E7EC" onmouseover="this.style.background='#C8D9ED'"
onMouseOut="this.style.background='#E4E7EC'">
<p align="center">
<a href="pdf files/invoice_4.pdf" class="link"style="color:blue;font-size:16px;">How to Use</a></div>
</fieldset>
</div>

<div class="col-md-3 " style="height: 250px;padding-bottom: 5px;">
<fieldset class="fieldset" style="">
<legend>3<sup>rd</sup> PAYMENT METHOD</legend>

<div align="center" style="background-color:#E4E7EC; margin-bottom:5px" onmouseover="this.style.background='#C8D9ED'" onMouseOut="this.style.background='#E4E7EC'" >
<a href="" class="link"style="color:blue;font-size:16px;">Mobile Payment</a></div>

<div align="center" style="background-color:#E4E7EC" onmouseover="this.style.background='#C8D9ED'"
onMouseOut="this.style.background='#E4E7EC'">
<p align="center">
<a href="" class="link"style="color:blue;font-size:16px;">Bank Payment</a></div>
                
<div align="center" style="background-color:#E4E7EC" onmouseover="this.style.background='#C8D9ED'"
onMouseOut="this.style.background='#E4E7EC'">
<p align="center">
<a href="" class="link"style="color:blue;font-size:16px;">GEPG Payment[option]</a></div>
...
<div class="col-md-3 " style="height: 250px;padding-bottom: 5px;">
<fieldset class="fieldset" style="">
<legend>4<sup>th</sup> APPLICATION </legend>

<div align="center" style="background-color:#E4E7EC; margin-bottom:5px" onmouseover="this.style.background='#C8D9ED'" onMouseOut="this.style.background='#E4E7EC'" >
<a href="" class="link"style="color:blue;font-size:16px;">Water Application</a></div>

<div align="center" style="background-color:#E4E7EC" onmouseover="this.style.background='#C8D9ED'"
onMouseOut="this.style.background='#E4E7EC'">
<p align="center">
<a href="" class="link"style="color:blue;font-size:16px;">Water Reconnection</a></div>
                
<div align="center" style="background-color:#E4E7EC" onmouseover="this.style.background='#C8D9ED'"
onMouseOut="this.style.background='#E4E7EC'">
<p align="center">
<a href="" class="link"style="color:blue;font-size:16px;">Sewage Application</a></div>
</fieldset>
