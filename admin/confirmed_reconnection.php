<?php
        if(!isset($_GET["rid"]))
        {
             ...
             header("location:index.php");
                ...
                $sql ="Select * from reconnection where id = '$id'";
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Water Service Applicant</td>
</tr>
</table>
...
<div class="row">
                    <div class="card-body">
                        <h1 class="page-header">
                            Water Reconnection<small> <?php echo  $curdate; ?> </small>
                        </h1>
                    </div>
...
<?php
                        ...
                        {   
                            ...
                            if($st=="Conform")
                            {
                                    $urb = "UPDATE `reconnection` SET `stat`='$st' WHERE id = '$id'";
                                                            ...
                                                            echo "<script type='text/javascript'> window.location='display_confirmed_reconnection.php'</script>";
                                                                ...
                                                                echo "<script type='text/javascript'> alert('Customer has not been Confirmed')</script>";
                                                                 ...
                                                                 echo "<script type='text/javascript'> window.location='confirmed_reconnection.php'</script>";
