...
<h5 style="font-size:20px; color:blue;">Sewage Service Applicant | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Sewage Service Applicant</td>
</tr>
</table>
 ...
 <div class="panel panel-info">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            ...
                                            <button class="btn btn-primary" type="button" style="font-size: 18px;"><i class="fa fa-users fa-5x">
                                                 </i> 
                                                 Sewage Application  <span class="badge"><?php echo $r ; ?></span>
                                            </button>
                                        ...
                                        {       
                                            ...
                                            echo"<div class='col-md-3 col-sm-12 col-xs-12'>
                                                    <div class='panel panel-primary text-center no-boder bg-color-blue'>
                                                        ...
                                                        <a href=print_sewage.php?sid=".$fid ."><button  class='btn btn-primary btn' data-toggle='modal' data-target='#myModal'>
                                                    Show
                                                    </button></a>
                                                            ".$mrow['Owner']."
                                                        </div>
