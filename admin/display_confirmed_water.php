                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            ...
                                            <button class="btn btn-primary" type="button" style="font-size: 18px;"><i class="fa fa-users fa-5x">
                                                 </i> Water Applicant  <span class="badge"><?php echo $r ; ?></span>
                                            </button>
                                        ...
                                        {       
                                            ...
                                            echo"<div class='col-md-3 col-sm-12 col-xs-12'>
                                                    <div class='panel panel-primary text-center no-boder bg-color-blue'>
                                                        ...
                                                        <a href=water_print.php?sid=".$fid ."><button  class='btn btn-primary btn' data-toggle='modal' data-target='#myModal'>
                                                    Show
                                                    </button></a>
                                                            ".$mrow['FName']."
                                                        </div>
