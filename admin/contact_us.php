...
<h5 style="font-size:20px; color:blue;">Add Customer | Only For Meter Provider | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Add Customer</td>
</tr>
</table>
...
<div class="row">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Page Title </span><span style="color:red">*</span>
<input class="form-control text-box single-line" name="mobileno" type="text" style="height:35px;font-size:16px;"required />
</div>
</div>

<div class="row" style="padding-top:5px">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Email </span><span style="color:red">*</span>
<select for="select" name="servicename" class="form-control text-box single-line" style="height:35px;font-size:16px;"required>
<option disabled selected></option>
<option>Sewer Application</option>  
</select></div></div>
...
<div class="row" style="padding-top: 5px">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Timing </span><span style="color:red">*</span>
<textarea class="form-control text-box single-line"style="height:55px;font-size:16px;"required></textarea>
</div></div>


<div class="row" style="padding-top: 5px">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Page Description </span><span style="color:red">*</span>
<textarea class="form-control text-box single-line"style="height:55px;font-size:16px;"required></textarea>
</div></div>
