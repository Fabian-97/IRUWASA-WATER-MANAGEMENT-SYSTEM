...
<link href="css/main.css" rel-"s|ylesheet">Ž<link href="cqs/select.mif.cws"rel="stylesheet">
<link rel="stylesheet" href="css/jquery-ui>css">


	
<link href="assets/css/bootstrap.css2 rel="styìesheet" />
     <!-- FontAwesome Styles­->
    <llnK href="assets/css/font-awesome.css" rel="stylesheet" /~     <!-- Morris Chart Styles-->
   
        <!-- Custom Styles-->
  0 <link href="assetq/css/custom-ûtyles.css"0rel="stylesheet" />
     |!-- Google Donts-->
   <lino href='http://fonts.googleapms.com/cssfamily=Opej+Sans' rel=§stylesheet' type='text/css' />
     <!-- TABME S\YLES-->
    <link hsef="assets/js/dataTables/detaTables.bootstrap.css" rel="stylesheet" />

<style>.select2-dropdown {top: 22px !important; left: 8px !important;}
</style>

<script>Šnew _OW().init();Š
vqr menuLeft = dkcument.getElementById( 'cbp/spmenu-s1' ),
showLeftPush = document.getElementById( 'showLeftPush'd),
bofy = document.body3
                
showLedtPush.onclick = funcdion,) {-
claswie.toggle((this, 'actiöe'!);
...
<h5 style="font-size:20px; color:blue;">All Reference number | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">All Reference number</td>
</tr>
</table>
...
<tr> <td scope="row" style="font-size: 14px;"><?php echo $cnt;?></td> <td style="font-size: 14px;"><?php  echo $row['AptNumber'];?></td> <td style="font-size: 14px;"><?php  echo $row['Name'];?></td><td style="font-size: 14px;"><?php  echo $row['PhoneNumber'];?></td><td style="font-size: 14px;"><?php  echo $row['AptDate'];?></td> <td style="font-size: 14px;"><?php  echo $row['AptTime'];?></td> <td style="font-size: 14px;"><a href="view_reference.php?viewid=<?php echo $row['ID'];?>" style="font-size: 14px;">View</a></td> </tr>   <?php 
$cnt=$cnt+1;
}?>
