...
@page { margin: 0; }
	...
	$sql ="select * from water where id = '$pid' ";
	...
	?>
		...
		<article>
			<h1></h1>
			<p style="text-align: center;font-weight: bold; font-size: 17px;">APPLICATION FOR WATER SUPPLY SERVICE</p>
			<br>
			...
			<table class="meta">
				...
				<tr>
					...
					<td><span ><?php echo $service; ?> </span></td>
				</tr>
				<tr>
					<th><span >Daily Use</span></th>
			...
			<table >
				...
				<tr> 
						<td>Request Water service for : -  <?php echo $water; ?> </td>
					</tr>
					<tr> 
					...
					<tr> 
						<td>Date of Payment : -  <?php echo $pay; ?> </td>
						<td>Street Name : -  <?php echo $street; ?> </td>
					</tr>

					<tr> 
						<td>House Number : -  <?php echo $house_no; ?> </td>
						
						<td>Job Title : -  <?php echo $job; ?> </td>
					</tr>

					<tr> 
						<td>Customer Age : -  <?php echo $age; ?> </td>
