...
<h5 style="font-size:20px; color:blue;">Add Service | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Add Service</td>
</tr>
</table>
<form method="post">
...
<div class="row">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Service Name </span><span style="color:red">*</span>
<input class="form-control text-box single-line" id="sername" name="sername"  type="text" style="height:35px;font-size:16px;"required />
</div>
</div>

<div class="row" style="padding-top:5px">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Service Cost </span><span style="color:red">*</span>
<input class="form-control text-box single-line" id="cost" name="cost"  type="text" style="height:35px;font-size:16px;"required /></div></div>
