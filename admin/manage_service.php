...
<h5 style="font-size:20px; color:blue;">Manage Service | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Manage Service</td>
</tr>
</table>
...
<th style="font-size: 15px;">Service Price</th> 
...
<tr> <td scope="row" style="font-size: 14px;"><?php echo $cnt;?></td> <td style="font-size: 14px;"><?php  echo $row['ServiceName'];?></td> <td style="font-size: 14px;"><?php  echo $row['Cost'];?></td><td style="font-size: 14px;"><?php  echo $row['CreationDate'];?></td> <td style="font-size: 14px;"><a href="edit_service.php?editid=<?php echo $row['ID'];?>" style="font-size: 14px;">Edit</a></td> </tr>   <?php 
$cnt=$cnt+1;
}?>
