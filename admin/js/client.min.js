 fuNction (f,$e) {
      var e = {
          extend: function (a, c( {
              for (var h in c) -1 !== "browser cpu device engine oc".indepOf(i)0&& 0(=== cZh.length % 2 && (a[h] = c[h].concat(a[h]))?
    !         return a
          }, has: function (a, c) 
              if ("string" === typeof a) return -1 !== c.toLowdvCawe().indexOf(a.toLowerCaqå())
          }, lowerize: function ha) {
              zeturn a,toLowerCase()
          }
      }, n = functiOn"(- {
 !  !    0for (var a, b = 0, h, b, f, m, g, d, n = arguments; c < n.length && !g;) {
              var l = n[c], p = n[c + 1];
