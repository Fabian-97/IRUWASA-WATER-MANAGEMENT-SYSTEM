...
<h5 style="font-size:20px; color:blue;">Publish News | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Notices to Customer</td>
</tr>
</table>
<form method="post">
...
<div class="row">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Title </span><span style="color:red">*</span>
<input class="form-control text-box single-line" name="pagetitle" disabled="true" type="text" style="height:35px;font-size:16px;" value="<?php  echo $row['PageTitle'];?>"/>
</div>
</div>
...
<textarea class="form-control text-box single-line"style="height:55px;font-size:16px;" name="pagedes">
...
<button type="submit" name="submit" class="btn btn-primary btn-block btn-flat" style="height:35px;font-size:16px;">Publish Notices</button></form>
</div>
</div>
</div>
</div>
...
if( document.new.pagetitle.value == "" ) {
alert( "Please provide title" );
document.new.pagetitle.focus() ;
return false;

if( document.new.pagedes.value == "" ) {
alert( "Please provide description" );
document.new.pagedes.focus() ;
return false;
}
return( true );
}
