...
<h5 style="font-size:20px; color:blue;">Add Payment | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Add Payment</td>
</tr>
</table>
...
<td style="font-size: 14px;"><?php  echo $row['ServiceName'];?></td> 
<td style="font-size: 14px;"><?php  echo $row['Cost'];?></td> 
<td style="font-size: 14px;"><input type="checkbox" name="sids[]" value="<?php  echo $row['ID'];?>" ></td> 
</tr>   
<?php 
$cnt=$cnt+1;
}?>
...
<button type="submit" name="submit" class="btn btn-default" style="font-size: 16px;">Submit</button>		
</td>
