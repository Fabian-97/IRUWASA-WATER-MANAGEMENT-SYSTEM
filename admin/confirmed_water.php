...
<div class="row">
                    <div class="card-body">
                        <h1 class="page-header">
                            Water Application<small> <?php echo  $curdate; ?> </small>
                        </h1>
                    </div>
                    ...
                    <div class="panel panel-info">
                        <div class="panel-heading">
                           Water Application Confirmation
                        </div>
...
<?php
                        ...
                        {   
                            ...
                            if($st=="Conform")
                            {
                                    $urb = "UPDATE `water` SET `stat`='$st' WHERE id = '$id'";
                                                            ...
                                                            echo "<script type='text/javascript'> window.location='display_confirmed_water.php'</script>";
                                                                ...
                                                                echo "<script type='text/javascript'> alert('Customer has not been Confirmed')</script>";
                                                                 ...
                                                                 echo "<script type='text/javascript'> window.location='confirmed_water.php'</script>";
