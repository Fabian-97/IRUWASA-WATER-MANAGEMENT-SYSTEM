...
<h5 style="font-size:20px; color:blue;">Generate Report | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Generate Daily Report</td>
</tr>
</table>
<form method="post" name="bwdatesreport"  action="sale_report_detail.php" enctype="multipart/form-data">
...
<div class="row">
	<div class="col-md-4">
<span style="font-size:16px;color:blue;">From </span><span style="color:red">*</span>
<input class="form-control text-box single-line"type="date" name="fromdate" id="fromdate" value="" style="height:35px;font-size:16px;"required/>
</div>

<div class="col-md-4">
<span style="font-size:16px;color:blue;">To </span><span style="color:red">*</span>
<input class="form-control text-box single-line"type="date" name="todate" id="todate" value="" style="height:35px;font-size:16px;"required/>
</div>
</div>

<div class="radio">

<p style="padding-top: 20px; font-size: 15px;color:blue;"> <strong>Request Type:</strong> <label>
<input type="radio" name="requesttype" value="mtwise" checked="true">
Month wise
</label>

<label>
<input type="radio" name="requesttype" value="yrwise">
Year wise
</label>
...
<button type="submit" name="submit" class="btn btn-primary btn-block btn-flat" style="height:35px;font-size:16px;">Generate Report</button>
</div>
</div>
</div>
</form></div>
