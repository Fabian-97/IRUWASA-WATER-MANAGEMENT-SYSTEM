...
<h5 style="font-size:20px; color:blue;">Sale Report | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Sale Report</td>
</tr>
</table>
...
<table id="zero_config" class="table table-striped table-bordered" style="font-size: 16px;">
...
<tr>
<td style="font-size: 14px;">S.NO</td>
<td style="font-size: 14px;">Month / Year </td>
<td style="font-size: 14px;">Sales</td>
</tr>
</thead>
<?php
...
<tr>
<th style="font-size: 15px;"><?php echo $cnt;?></th>
<th style="font-size: 15px;"><?php  echo $row['lmonth']."/".$row['lyear'];?></th>
<th style="font-size: 15px;"><?php  echo $total=$row['totalprice'];?></th>
...
<td colspan="2" align="center" style="font-size: 14px;">Total </td>
<td style="font-size: 14px;"><?php  echo $ftotal;?></td>
...
<tr>
<td style="font-size: 14px;"><?php echo $cnt;?></td>
<td style="font-size: 14px;"><?php  echo $row['lyear'];?></td>
<td style="font-size: 14px;"><?php  echo $total=$row['totalprice'];?></td>
...
<tr>
<td colspan="2" align="center" style="font-size: 15px;">Total </td>
<td style="font-size: 15px;"><?php  echo $ftotal;?></td>
