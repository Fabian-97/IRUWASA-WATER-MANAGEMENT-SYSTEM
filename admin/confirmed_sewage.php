<?php
        if(!isset($_GET["rid"]))
        {
             ...
             header("location:index.php");
                ...
                $sql ="Select * from sewage where id = '$id'";
...
<h5 style="font-size:20px; color:blue;">Water Service Applicant | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Sewage Service Application</td>
</tr>
</table>
...
<div class="row">
                    <div class="card-body">
                        <h1 class="page-header">
                            Sewage Application<small> <?php echo  $curdate; ?> </small>
                        </h1>
                    </div>
                    ...
                    <div class="panel panel-info">
                        <div class="panel-heading">
                           Sewage Application Confirmation
                        </div>
                               ...
                               <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo $ref_number; ?> </th>
                                            
                                        </tr>
                                        <tr>
                                            <th>Parmanent Area of Resident</th>
                                            <th><?php echo $resident; ?> </th>
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo $rcondition; ?></th>
                                            
                                        </tr>
                                        <tr>
                                            <th>Application Date </th>
                                            <th><?php echo $adate; ?></th>
                                        ...
                                        <tr>
                                            <th>Payment Date </th>
                                            <th><?php echo $pdate; ?></th>
                                            
                                        </tr>
                                        <tr>
                                            <th>A gree term and Policy</th>
                                            <th><?php echo $term; ?></th>
                        ...
                        <div class="panel-footer">
                            <form method="post">
                                        <div class="form-group">
                                                        ...
                                                        <select name="conf"class="form-control"  style="height: 30px;">
...
<?php
                        ...
                        {   
                            ...
                            if($st=="Conform")
                            {
                                    $urb = "UPDATE `sewage` SET `stat`='$st' WHERE id = '$id'";
                                                            ...
                                                            {
                                                            echo "<script type='text/javascript'> alert('Customer has been Confirmed')</script>";

                                                            echo "<script type='text/javascript'> window.location='display_confirmed_sewage.php'</script>";
                                                           
                                                            }else{



                                                                echo "<script type='text/javascript'> alert('Customer has not been Confirmed')</script>";

                                                                 echo "<script type='text/javascript'> window.location='confirmed_sewage.php'</script>";
