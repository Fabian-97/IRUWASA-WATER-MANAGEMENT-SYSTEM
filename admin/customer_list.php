...
<h5 style="font-size:20px; color:blue;">Customer List | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Customer List</td>
</tr>
</table>
...
<tr> <td scope="row" style="font-size: 14px;"><?php echo $cnt;?></td> <td style="font-size: 14px;"><?php  echo $row['Name'];?></td> <td style="font-size: 14px;"><?php  echo $row['Service'];?></td><td style="font-size: 14px;"><?php  echo $row['CreationDate'];?></td> <td style="font-size: 14px;"> ||  <a href="add_payment.php?addid=<?php echo $row['ID'];?>" style="font-size: 14px;">Assign Invoice</a></td> </tr><?php 
$cnt=$cnt+1;
}?>
