...
<h5 style="font-size:20px; color:blue;">Invoices number | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">invoices number</td>
</tr>
</table>
...
<th style="font-size: 15px;">Invoice Date</th> 
...
<td style="font-size: 15px;"><a href="view_invoice.php?invoiceid=<?php  echo $row['BillingId'];?>" style="font-size: 15px;">View</a></td> 
