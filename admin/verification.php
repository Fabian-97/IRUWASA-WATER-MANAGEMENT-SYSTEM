...
<h5 style="font-size:20px; color:blue;">Mobile Verification | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Mobile Number Verification</td>
</tr>
</table>
<form method="post">
...
<input class="form-control text-box single-line" type="number" id="mobile" style="height:35px;font-size:16px;"required placeholder="Enter the 10 digit mobile"/>
</div>
</div>
...
<button type="submit" onClick="sendOTP();" class="btn btn-primary btn-block btn-flat" style="height:35px;font-size:16px;">Send OTP</button>
</div>
</div>
</div>
</form></div>
...
<script src="js/jquery-3.2.1.min-verification.js" type="text/javascript"></script>
