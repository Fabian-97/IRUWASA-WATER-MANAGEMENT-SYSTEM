...
$chngpwd1->execute();
$msg = "<center><div class='alert alert-success'>Your Password succesfully changed..</div></center>";
}
else {
$msg = "<center><div class='alert alert-danger'>Something went wrong. Please try again..</div></center>"; 
}
}
...
<h5 style="font-size:20px; color:blue;">Change password | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Change Password</td>
</tr>
</table>
...
<div class="row">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Current Password </span><span style="color:red">*</span>
<input class="form-control text-box single-line" name="password"  type="password" style="height:35px;font-size:16px;"required />
</div>
</div>

<div class="row" style="padding-top:5px">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Enter Password </span><span style="color:red">*</span>
<input class="form-control text-box single-line" name="newpassword"  type="password" style="height:35px;font-size:16px;"required /></div></div>


<div class="row" style="padding-top:5px">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Confirm Password </span><span style="color:red">*</span>
<input class="form-control text-box single-line" name="confirmpassword"  type="password" style="height:35px;font-size:16px;"required /></div></div>


<div class="row" style="padding-top: 20px">
<div class="col-md-offset-4 col-md-4">
<button type="submit" name="change" class="btn btn-primary btn-block btn-flat" style="height:35px;font-size:16px;">Submit</button>
</div>
</div>
</div>
</form></div>
