...
<div class="form-group"> <label for="exampleInputEmail1" style="font-size: 16px;">Search by Invoice Number or Billing Number</label><input id="searchdata" type="text" name="searchdata" required="true" class="form-control" style="font-size: 16px; height: 10%;">
