...
<h5 style="font-size:20px; color:blue;">Rejected Reference Number | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Rejected Reference number</td>
</tr>
</table>
...
<tr> <td scope="row" style="font-size: 14px;"><?php echo $cnt;?></td> <td style="font-size: 14px;"><?php  echo $row['AptNumber'];?></td> <td style="font-size: 14px;"><?php  echo $row['Name'];?></td><td style="font-size: 14px;"><?php  echo $row['PhoneNumber'];?></td><td style="font-size: 14px;"><?php  echo $row['AptDate'];?></td> <td style="font-size: 14px;"><?php  echo $row['AptTime'];?></td> <td style="font-size: 15px;"><a href="view_reference.php?viewid=<?php echo $row['ID'];?>" style="font-size: 15px;">View</a></td> </tr>   <?php 
$cnt=$cnt+1;
}?>                                           
