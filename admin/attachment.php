...
<h5 style="font-size:20px; color:blue;">Passport size | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">All user passport size</td>
</tr>
</table>
...
<?php $fetchqry = "SELECT * FROM `image` ORDER BY time DESC"; 
    ...
    while($row = mysqli_fetch_array($result,MYSQLI_ASSOC)){ ?>
      ...
      <tr><td><p><?php echo $row['title'];?></p></td><td><img src="../upload/<?php echo $row['imagename']?>" width="450" height="650" /> </td>
