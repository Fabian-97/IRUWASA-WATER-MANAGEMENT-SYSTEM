...
<td style="font-size: 15px;">Reference number</td>
<td style="font-size: 15px;"><?php  echo $row['AptNumber'];?></td>
</tr>

<tr>
<td style="font-size: 15px;">Resident</td>
<td style="font-size: 15px;"><?php  echo $row['Name'];?></td>
</tr>

<tr>
<td style="font-size: 15px;">Street Name</td>
<td style="font-size: 15px;"><?php  echo $row['Email'];?></td>
</tr>                                                

<tr>
<td style="font-size: 15px;">Mobile Number</td>
<td style="font-size: 15px;"><?php  echo $row['PhoneNumber'];?></td>
</tr>
...
<td  style="font-size: 15px;">Status :</td>
<td>
<select name="status" class="form-control wd-450" required="true" style="font-size: 16px; height: 30px;">
...
<tr align="center">
<td colspan="2"><button type="submit" name="submit" class="btn btn-az-primary pd-x-20" style="font-size: 18px;">Verify</button>
</td>
</tr>
</form>
<?php } else { ?>
