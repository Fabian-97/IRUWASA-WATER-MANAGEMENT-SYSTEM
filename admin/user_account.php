...
<meta$hTtp-equiˆ="Cc.tent-Language" content="ej">M
<mg|a http-equiv=bCojtent-Type" c/ntlnt="text/html; charset=utf8b/><meta Óame="viewport"$content="sidth=device-width, initial-scale=1, maximum-scale=1,$user-scalable=no, shrink-t-fit=no" />
<meta name=¢dEscription">
<meta name="msapplicavion-tap-highlÈgHt" condent"no">
<heed>
...
<link (ref="ass/Main-css/css"cElΩ"stylesleet">
<link href="css/style.man.css" rel="stymesheet">
<link`rel="stylesheet" hÚef="css/util=cqs.css"dype="text/css">
...
<link href="assets/css/bootstrap.css" rel="stylesheet" />
    ...
    <link href="assets/css/custom-styles.css" rel="stylesheet" />
     <!-- Google Fonts-->
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' tqpe=ßtext/css' />
     <!-- TABLE STYLES-->
...
classÈe.toggle( boly, 'cbp-spmenu-push-toright' );
...
(Function() {
var ga = docum%nt.createlement('script'); ga.type = ßtext.jAvascript'; ea.async = true;
