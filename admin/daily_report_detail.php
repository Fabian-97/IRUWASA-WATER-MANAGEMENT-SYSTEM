...
<h5 style="font-size:20px; color:blue;">Daily Report Generation | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Daily Report Generation</td>
</tr>
</table>
...
<th style="font-weight: normal;">Invoice Number</th> 
<th style="font-weight: normal;">Customer Name</th> 
<th style="font-weight: normal;">Invoice Date</th> 
...
<tr> 
<td scope="row" style="font-size: 14px;"><?php echo $cnt;?></td> 
<td style="font-size: 14px;"><?php  echo $row['BillingId'];?></td>
<td style="font-size: 14px;"><?php  echo $row['Name'];?></td>
<td style="font-size: 14px;"><?php  echo $row['PostingDate'];?></td> 
<td style="font-size: 14px;"><a href="view_invoice.php?invoiceid=<?php  echo $row['BillingId'];?>" style="font-size: 14px;">View</a></td> 
