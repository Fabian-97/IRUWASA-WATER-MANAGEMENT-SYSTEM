...
<h5 style="font-size:20px; color:blue;">Reply Message | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Reply Message</td>
</tr>
</table>
        ...
        $rew = mysqli_query($con,$mail);
         ...
         <div class="row">
            ...
            <div class="panel-body">
                            ...
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <h4 align="center"style="color:blue;">Reply a shortly Message</h4>
                    <form method="post">
              ...
              if(isset($_POST['log']))
              { 
                $log ="INSERT INTO `send`(`title`, `subject`, `news`) VALUES ('$_POST[title]','$_POST[subject]','$_POST[news]')";
                if(mysqli_query($con,$log))
                {
                  echo '<script>alert("Reply has been done") </script>' ;
                    ...
                    while($row = mysqli_fetch_array($re))
                    {
                      ...
                      if($id % 2 ==1 )
                      {
                        echo"<tr class='gradeC'>
                          ...
                          <td>".$row['cdate']."</td>
                          <td>".$row['approval']."</td>
                          <td><a href=permission_follower.php?eid=".$id ." <button class='btn btn-primary'> <i class='fa fa-edit' ></i> Permission</button></td>
                          <td><a href=delete_follower.php?eid=".$id ." <button class='btn btn-danger'> <i class='fa fa-edit' ></i> Delete</button></td>
                        </tr>";
                      }
                      else
                      {
