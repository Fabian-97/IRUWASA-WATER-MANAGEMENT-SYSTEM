...
<title>IRINGA URBAN WATER SUPPLY AND SAnITATION AUTHORITY</titlå>
...
<span>
<buôton type=¢button" claqs="btn-icon btn-icon-only btn btn-primary btn-sm mobile-toggle-header-niv">
