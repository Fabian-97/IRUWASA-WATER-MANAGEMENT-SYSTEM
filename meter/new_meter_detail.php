...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Meter Number List</td>
</tr>
</table>
...
<tbody>
<?php
$ret=mysqli_query($con,"select *from  newmeter");
$cnt=1;
...
<td style="font-size: 14px;"><?php  echo $row['NewMeter'];?></td>
<td style="font-size: 14px;"><?php  echo $row['Resident'];?></td> 
<td style="font-size: 14px;"><?php  echo $row['Street'];?></td>
<td style="font-size: 14px;"><?php  echo $row['OMeter'];?></td> 
...
<td style="font-size: 14px;"><?php  echo $row['PNumber'];?></td>
<td style="font-size: 14px;"><?php  echo $row['Date'];?></td>
<td style="font-size: 14px;"><a href="new_meter_print.php?printid=<?php echo $row['id'];?>" style="font-size: 14px;"><img src="img/6.jpg" height="40%"></a></td> 
