...
<h5 style="font-size:20px; color:blue;">New Meter Number | Meter Number | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">New Meter Number</td>
</tr>
</table>

<!--#######################reference###############################################--->

<h4>Thank you, Your New Meter Number is  <?php echo $_SESSION['newmeter'];?>  </h4>
