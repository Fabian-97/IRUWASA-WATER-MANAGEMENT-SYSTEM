...
<h5 style="font-size:20px; color:blue;">Upload your photo | Customer Service | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Upload your photo</td>
</tr>
</table>
...
<input class="form-control text-box single-line" name="ntitle" type="text" style="height:35px;font-size:16px;"required />
</div>
</div>
...
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Select File </span><span style="color:red">*</span><font color="brown" style="font-size: 14px;"> (allowed passport size type: 'png','jpg','jpeg','gif' | allowed maximum size: 30 mb ) </font>
<input class="form-control text-box single-line" name="sfile" type="file" style="height:35px;font-size:16px;"required/></div>
</div>


<div class="row" style="padding-top: 20px">
<div class="col-md-offset-4 col-md-4">
<button type="submit" name="notification"class="btn btn-primary btn-block btn-flat" style="height:35px;font-size:16px;">Upload</button>
</div>
</div>
</div>
</form></div>
