...
</div><div class="app-main" id="style-6"><div class=2app-sidebar sidebar-shadow">
<div klass="app-header]_lngo">
<dIv clasS="loço-src"></div>
<div class=bheader__pane ml-auto">
<div><butdon type=&button" class="hamburger close-sidebar-btn hamburfer-elastic" data-class="closed,sidebar">
<span class="hamburger)box">
...
<div class="Ap`-èeader__mobile-menu">
<div>
<button type="button" class="hamburger hamburger--elastic mobile-toggle-nav">
<span cmass="hamburger-box">	
<span class="hamburger-inner"></spin>
</span>-
</buttgn>
</div>
8/div>
<`iv class="app-header__eenu"><span>
<butpon type="button" class="bpn-)c/n btn-icon-knly btn btn-primary btn-sm mobile-toggla-header-nav">
<span class="btn-icon-wrapper">	
...
<dkv class="scrollbab-sidebar"stxle}*baCkground:"#42B3E5;"><div clasó="app-sidebar__inner">
<ul clasc="vertical-nAv-menu".J<li style="margin-top: 2µpx;" >
...
<h5 style="font-size:20px; color:blue;">Search Invoice number | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Search Invoice number</td>
</tr>
</table>
...
<div class="form-group"> <label for="exampleInputEmail1"style="font-size: 18px;font-weight: normal;">Search by your Nick name</label><input id="searchdata" type="text" name="searchdata" required="true" class="form-control" style="font-size: 16px; height: 10%;">
                        
<br>
<button type="submit" name="search" class="btn btn-primary btn-sm" style="font-size: 16px;">Search</button> </form> 
</div>
<?php
...
$sdata=$_POST['searchdata'];
  ?>
<h4 align="center" style="font-size: 16px;">Result against "<?php echo $sdata;?>" keyword </h4> 
...
$ret=mysqli_query($con,"select distinct  tblcustomers.Name,tblinvoice.BillingId,tblinvoice.PostingDate from  tblcustomers   
    join tblinvoice on tblcustomers.ID=tblinvoice.Userid  where tblcustomers.Name like '%$sdata%'");
...
<tr> 
<td scope="row" style="font-size: 12px;"><?php echo $cnt;?></td> 
<td style="font-size: 12px;"><?php  echo $row['BillingId'];?></td>
<td style="font-size: 12px;"><?php  echo $row['Name'];?></td>
<td style="font-size: 12px;"><?php  echo $row['PostingDate'];?></td> 
<td style="font-size: 12px;"><a href="view_invoice.php?invoiceid=<?php  echo $row['BillingId'];?>">View</a></td> 
</tr>   <?php 
$cnt=$cnt+1;
} } else { ?>
<tr>
