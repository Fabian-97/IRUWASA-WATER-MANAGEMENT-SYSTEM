...
<h5 style="font-size:20px; color:blue;">Sent us Message | P.o Box 570 | 
<script>
function show2(){
...
<table class="table">
<tr class="form4">
<td colspan="3"align="center"style="font-size:20px;">Sent us short Message</td>
</tr>
</table>
...
<input type="text" name="mobile" class="form-control text-box single-line" style="height:35px;font-size:16px;"required>
</div>
</div>
...
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Complaint Category </span><span style="color:red">*</span>
<input type="text" name="category" class="form-control text-box single-line" style="height:35px;font-size:16px;"required>
</div></div>
...
<div class="row" style="padding-top:5px">
<div class="col-md-8">
<span style="font-size:16px;color:blue;">Complaint Description </span><span style="color:red">*</span>
<textarea class="form-control text-box single-line" style="height:100px;font-size:16px;" name="description" required="true"></textarea>
</div></div>

<div class="row" style="padding-top: 20px">
<div class="col-md-offset-4 col-md-4">
<button type="submit" name="submit" class="btn btn-primary btn-block btn-flat" style="height:35px;font-size:16px;">Sent Message</button>
</div>
</div>
</div>
...
<?php
				if(isset($_POST['submit']))
				{
					...
					$sql = "INSERT INTO `contact`(`Mobile`, `Category`, `Description`,`cdate`,`approval`) VALUES ('$mobile','$category','$description',now(),'$approval')" ;
